...
### A .Rmd Template
Create a new blank document based on the template by calling `rmarkdown::draft("my_article.Rmd", template = "jss_article", package = "rticles")
`. For example, to create a new tipsheet called "Working with COVID-19 Data", call:
...
*TODO: insert image. Store in `man/figures/`.*
