...
They can be accessed through RStudio via the [`googledrive`
...
-   [ ] Wite a `knit_template` function that will regenerate Rmd
    templates in Drive
-   [ ] ~~Workflows and functions to convert from one template to
    another~~
