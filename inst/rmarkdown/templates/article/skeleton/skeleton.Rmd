...
Update this template with your custom content. Change document properties in the YAML header (between the two sets of `---` marks at the top of this document). 

Render the formatted output document in R Studio by pressing the `Knit` button in or using the `Shift + Ctrl + K` shortcut.
